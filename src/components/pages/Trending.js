import backImage from "../../img/fundo5.mp4"
...
import filme100 from "../../img/filme11.2.jpg"
    ...
    return (
        <section>   
            ...
            <div className="absolute text-start bottom-40 pl-12 text-white">
                <p className="text-xl pb-4">WATCH OUR MOST POPULAR MOVIES & TV SHOWS AVALIABLE!!</p>
                <h1 className="text-3xl pb-6 font-extrabold font-filme hover:scale-110 hover:cursor-pointer duration-500 text-transparent bg-clip-text bg-gradient-to-b from-red-700 to-black">HOW I LOST HIM!!</h1>
                <button className="w-36 rounded hover:scale-110 duration-500 bg-gradient-to-r from-black to-transparent text-center p-2">WATCH NOW!</button>
            </div>
            <div className="h-[1000px] bg-zinc-900">
                <h1 className="text-white absolute top-[700px] pl-12 text-xl">Released this year</h1>
                ...
                <h1 className="text-white absolute top-[960px] pl-12 text-xl">Trending Right Now</h1>
                ...
                <h1 className="text-white absolute top-[1220px] pl-12 text-xl">Top 10 Movies & TW Shows In The World</h1>
                <div className="absolute top-[1250px]">
                    <div className={`w-[1335px] ml-2 pl-10 pt-8 h-[350px] ${styles.scroll} flex gap-x-24 overflow-x-scroll`}>
                        <div className={`${styles.teste}`}>
                            ...
                            <Card2 image={lista[28]} tops={lista2[2]}></Card2>
