import backImage from "../img/fundo3.mp4";
  ...
  return (
    <section>
      ...
      <div className="absolute text-start bottom-40 pl-12 text-white">
        ...
        <h1 className="text-3xl pb-6 font-extrabold font-filme hover:cursor-pointer duration-500 text-transparent bg-clip-text bg-gradient-to-b from-zinc-700 to-red-600">
          LOST ISLAND!!
        </h1>
        <button className="w-36 rounded hover:scale-110 text-black font-semibold duration-500 bg-gradient-to-r from-white to-transparent text-center p-2">
          WATCH NOW!
        </button>
      </div>
      <div className="h-[1000px] bg-zinc-900">
        ...
        <h1 className="text-white absolute top-[1220px] pl-12 text-xl">
          Top 10 Movies In The World Right Now
        </h1>
