    ...
    <section>
      ...
      <div className="absolute text-start bottom-40 pl-12 text-white">
        <p className="text-xl pb-4">
          WATCH OUR MOST POPULAR MOVIES & TV SHOWS AVALIABLE!!
        </p>
        <h1 className="text-3xl pb-6 font-extrabold font-filme hover:cursor-pointer duration-500 text-transparent bg-clip-text bg-gradient-to-b from-red-700 to-black">
          HOW I LOST HIM!!
        </h1>
        <button className="w-36 rounded hover:scale-110 duration-500 bg-gradient-to-r from-black to-transparent text-center p-2">
          WATCH NOW!
        </button>
      </div>
