  ...
  return (
    <section>
      ...
      <div className="absolute text-start bottom-40 pl-12 text-white">
        ...
        <h1 className="text-3xl pb-6 font-extrabold font-filme hover:cursor-pointer duration-500 text-transparent bg-clip-text bg-gradient-to-b from-orange-800 to-yellow-950">
          THE FORGOTTEN PASSAGE!!
        </h1>
        <button className="w-36 rounded hover:scale-110 duration-500 bg-gradient-to-r from-orange-800 to-transparent text-center p-2">
          WATCH NOW!
        </button>
      </div>
      <div className="h-[1000px] bg-zinc-900">
        <h1 className="text-white absolute top-[660px] pl-12 text-xl">
        ...
        <h1 className="text-white absolute top-[920px] pl-12 text-xl">
          Trending Right Now
        </h1>
        ...
        <h1 className="text-white absolute top-[1180px] pl-12 text-xl">
          Top 10 TV Shows In The World Right Now
        </h1>
